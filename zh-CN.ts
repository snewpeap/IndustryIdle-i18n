export const ZH_CN = {
    ...
    Fiber: "Fiber",
    Achievements: "成就",
    AchievementsDesc: "你已经达成了所有%{total}项成就中的%{number}项",
    AchievementsReward: "奖励: 瑞士货币+%{swiss}",
    AchievementsRewardToast: "你领取了奖励: 瑞士货币+%{swiss}",
    AchievementsClaim: "领取",
    AchievementsToast: "你达成了 %{name} 成就，请在总部领取你的奖励",
    ...
    SteamAutoCloudBackup: "Steam自动云备份",
    SteamAutoCloudBackupDesc:
        "游戏会自动保存到你的本地存档。你的本地存档每10分钟会与Steam云同步一次。你随时可以强制Steam云同步。",
    SteamAutoCloudBackupFailed: "Steam自动云备份失败: %{error}",
    SteamManualBackup: "强制Steam云同步",
    UILoading: "加载中...",
    UserAuthenticated: "您已通过验证",
};
